from nbgrader.server_extensions.formgrader.formgrader import (
    FormgradeExtension as NbgraderFormgradeExtension,
)
    ...
    def init_tornado_settings(self, webapp):
        ...
        jinja_env = Environment(
            loader=FileSystemLoader(
                [handlers.template_path, nbgrader_handlers.template_path]
            ),
            autoescape=True,
        )
